...
<html lang="zxx">
<head>
	<title><?php getwebname("titles"); echo"|"; gettagline("titles");?>| Our Team</title>
	...
	<link rel="stylesheet" type="text/css" href="team/css/style.css" /> <!-- Main stylesheet /-->
	<link rel="stylesheet" type="text/css" href="team/css/bootstrap.css"> <!-- Grid framework /-->
...
<body>
	<!--Header-->
	<?php include("header_team.php");?>
	<!--//header-->
	<!--/banner-->
	<div class="banner-inner-team">
	</div>
	<ol class="breadcrumb">
	...
	<section id="speakers">
		...
		<div class="container">
			...
			<div class="row1">
				...
				<div class="col-md-3">
					<a href="#" class="member-profile">
						...
						<img src="team/img/waseem.png" alt="" />
						</div>
						<div class="hover_img">
						<img src="team/img/waseem.png" alt="" />
						</div>
						<span>Founder & CEO</span>
						<h4><span>Waseem</span> Akaram</h4>
					</a>
					<ul>
				...
				<div class="col-md-3">
					<a href="#" class="member-profile">
						...
						<img src="team/img/bijendar-f.png" alt="" />
						</div>
						<div class="hover_img">
						<img src="team/img/bijendar-f.png" alt="" />
						</div>
						<span>Chief Financial officer</span>
						<h4><span>Bijendar</span> Kushwaha</h4>
					</a>
					<ul>
				...
				<div class="col-md-3">
					<a href="#" class="member-profile">
						<div class="unhover_img">
							<img src="team/img/purus-f.jpg" alt="" />
						</div>
						<div class="hover_img">
						<img src="team/img/purus-ff.jpeg" alt="" />
						</div>
						<span>Chief Information Officer</span>
						<h4><span>Purushottam</span> Parbhakar</h4>
					</a>
					<ul>
				...
				<div class="col-md-3">
					<a href="#" class="member-profile">
						<div class="unhover_img">
						<img src="team/img/kamesh-f.png" alt="" />
						</div>
						<div class="hover_img">
						<img src="team/img/kamesh-f.png" alt="" />
						</div>
						<span>Chief Executive Manager</span>
						<h4><span>Kamesh</span> Shekhar</h4>
					</a>
					<ul>
						<li><a href="#" target="_blank"><i class="fa fa-twitter"></i></a></li>
						<li><a href="#"  target="_blank"><i class="fa fa-linkedin"></i></a></li>
			...
			<!-- View All Button -->
			<div class="col-md-12">
				<button class="btn btn-transparent fadeIn">Meet All</button>
			</div>
